...
Select COUNT(*) ' Count Of Transaction Table ' from Transactions
Select COUNT(*) ' Count of Customer Table ' from Customer
Select COUNT(*)' Count of Product Cat Info Table ' from prod_cat_info


-- Q2 What is the total number of transactions that have a return?

Select COUNT(total_amt) ' Count of Return ' from Transactions
Where total_amt<0
...
Select Count(prod_subcat) 'Total Sub-Categories Under Category Books'   from prod_cat_info
...
-- Q8 What is the combined revenue earned from the "Electronics" & "Clothing" categories, from "Flagship stores"?
 ...
 Select T1.prod_cat ,Sum(T2.total_amt) 'Total Revenue Generated' from prod_cat_info T1 inner join Transactions T2 on T1.prod_cat_code = T2.prod_cat_code 
...
select p.prod_subcat, AVG(total_amt)'Average Sales by Sub-Category'  , SUM(total_amt)'Total Sales by Sub-Category'  from Transactions t join prod_cat_info p 
